...
struct sipp_option options_table[] = {
   ...
   {"noscreen", "Disable statistics scren.\n", SIPP_OPTION_SETFLAG, &noscreen, 1},
...
//     {"trace_timeout", "Displays call ids for calls with timeouts in <scenario file name>_<pid>_timeout.log", SIPP_OPTION_SETFLAG, &useTimeoutf, 1},
    ...
    {"mqtt_client_id", "Set the MQTT client id for connecting to broker. Default is auto-generated.", SIPP_OPTION_STRING, &mqtt_client_id, 1},
    ...
    {"mqtt_sub_qos", "Set the QoS when subscribing to the MQTT broker. Default is 1.", SIPP_OPTION_INT, &mqtt_sub_qos, 1},
...
#else
    {"mqtt_client_id", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
    ...
    {"mqtt_countstats_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
    {"mqtt_codestats_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
    {"mqtt_error_topic", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
    ...
    {"mqtt_sub_qos", NULL, SIPP_OPTION_NEED_MQTT, NULL, 1},
